...
public class ConcreteStrategyMountain implements BikeStrategy {
	List<Bike> bikes = BikeConfiguration.getInstance().getConfigurations("BikeConfigRes/mountain.csv");
